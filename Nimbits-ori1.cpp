...
void Nimbits::recordValue(double value, int decpoint, String note, char *pointId) {
...
//    client.println("Host:nimbits-02.appspot.com");
	client.println("Host: phnimb.appspot.com");
	...
	client.stop();
	  ...
	  Serial.println("Nepodarilo se navazat spojeni na server");
  }
